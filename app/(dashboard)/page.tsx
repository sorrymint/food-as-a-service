...
function BodyAndAvartar(){
  return (
  <section>
    <div className='w-full flex flex-col gap-[2rem] items-center md:flex-row-reverse l lg:gap-15 lg:justify-center'>

      <Image 
      src={'/shrimpdish.jpg'} 
      alt='A picture of a delicous burger' 
      width={400} 
      height={200}
