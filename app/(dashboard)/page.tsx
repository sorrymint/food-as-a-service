...
function BodyAndAvatar() {
    const [buttons, setButtons] = useState([
        { id: 1, text: "Order", color: "#181818", textColor: "#fff", border: false },
        { id: 2, text: "Menu", color: "#fff", textColor: "#000", border: true }
    ]);
    ...
    return (
        <section>
            <div className='w-full flex flex-col gap-[2rem] items-center md:flex-row-reverse lg:gap-15 lg:justify-center'>
                ...
                <Image
                    src={'/shrimpdish.jpg'}
                    alt='A picture of a delicious shrimp dish'
                    width={400}
                    height={200}
                    className='w-[100%] md:w-[50%] lg:w-[30%] rounded-md'
                />

                <div className='md:flex md:flex-col md:gap-10 md:-mt-30 lg:items-start lg:h-[400px] lg:mt-0'>
                    <h2 className='hidden text-7xl font-bold text-center md:block'>
                        Hope you&apos;re Hungry!!
                    </h2>

                    <div className='flex flex-col gap-4 w-full items-center lg:flex-row flex-wrap lg:gap-8'>
                        {buttons.map(({ id, text, color, textColor, border }) => (
                            <Button
                                key={id}
                                style={{
